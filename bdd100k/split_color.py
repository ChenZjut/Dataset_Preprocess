...
def main():
    xmls_path = './BDDVOC/Annotations/val'
    image_path = './BDDVOC/JPEGImages/val'
    save_xml_path = './Yellow/Annotations'
    save_image_path = './Yellow/JPEGImages'
    ...
    for f in os.listdir(xmls_path):
        ...
        for i in range(len(xyxys)):
            ...
            if xyxy[0] in labels:
                ...
                image_name = os.path.join(image_path, f.replace('xml', 'jpg'))
